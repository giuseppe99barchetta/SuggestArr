...
class TMDbDiscover:
    ...
    async def _discover(
        ...
        for page in range(1, pages_needed + 1):
            ...
            # ⚡ Bolt Optimization: Process items in concurrent batches instead of sequentially.
            # This significantly reduces IMDB lookup latency (two API calls per item) by processing
            # up to 5 items at a time, keeping overall latency low while avoiding rate limits.
            batch_size = 5
